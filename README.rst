...
to report a vulnerability, and the
`releases <https://github.com/melexis/submodule-guardian/releases>`_ what changed per release.
...
The `release notes <https://github.com/melexis/submodule-guardian/releases>`_, generated by GitHub
from the pull requests that went in, summarize what changed per release.
